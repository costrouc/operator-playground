...
import (
	...
	cachev1alpha1 "github.com/costrouc/memcached-operator/api/v1alpha1"
)

const memcachedFinalizer = "cache.ostrolabs.com/finalizer"
...
//+kubebuilder:rbac:groups=cache.ostrolabs.com,resources=memcacheds,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=cache.ostrolabs.com,resources=memcacheds/status,verbs=get;update;patch
